let Deck,Player,scanf;_fbc‍.w("./Deck",[["Deck",["Deck"],function(v){Deck=v}]]);_fbc‍.w("./Player",[["Player",["Player"],function(v){Player=v}]]);_fbc‍.w("./node_modules/scanf",[["default",["scanf"],function(v){scanf=v}]]);
...
for(let player of players){
    ...
    while(true){
        ...
        _fbc‍.g.console.log(player.score);
        if(player.score == 21) {
...
while(true){
    ...
    _fbc‍.g.console.log(dealer.score);
    if(dealer.score == 21) {
        console.log("BLACKJACK!");
        break;
    }
